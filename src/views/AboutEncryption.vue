    ...
    <div v-if="loaded" class="settingsScreen">
      <div class="settingsApp">
        <img
          ...
          alt="Security guard guarding data"
        />
        <h1 class="heading">Graphite Writer Encryption</h1>
        <p class="text">
          By default Graphite Writer documents are transferred over https, this
          means that your documents are scrambled and encrypted between your
          device and our servers. However, documents are currently not stored in
          an encrypted format. We are working on building methods that will
          allow your documents to always be encrypted.
        </p>
        <div class="actions">
